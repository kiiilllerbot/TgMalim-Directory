...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post holidays_url, params: { holiday: { name: @holiday.name, user_id: @holiday.user_id } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { name: @holiday.name, user_id: @holiday.user_id } }
